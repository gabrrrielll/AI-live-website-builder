            ...
            <>
                ...
                <main className="bg-white">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 py-4 bg-white">
                        <nav className="flex items-center space-x-1 sm:space-x-2 text-sm text-gray-600 overflow-x-auto scrollbar-hide">
                            <Link to="/" className="flex items-center hover:text-[#c29a47] transition-colors whitespace-nowrap">
                                <Home size={16} className="mr-1" />
                                {t.blogPage.breadcrumbHome}
                            </Link>
                            <ChevronRight size={16} className="flex-shrink-0" />
                            <Link to="/blog" className="hover:text-[#c29a47] transition-colors whitespace-nowrap">
                                {t.blogPage.breadcrumbBlog}
                            </Link>
                            <ChevronRight size={16} className="flex-shrink-0" />
                            <span className="text-gray-800 font-medium truncate max-w-xs sm:max-w-sm">
                                {articleTitle}
                            </span>
                        </nav>
                    </div>
