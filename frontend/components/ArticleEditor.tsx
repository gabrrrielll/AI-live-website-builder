    ...
    if (!isEditMode) {
        return (
            <div className="min-h-screen bg-white">
                <article className="container mx-auto px-4 sm:px-6 py-12 max-w-4xl bg-white">
                    <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 break-words">{article.title[language]}</h1>
            ...
            <div className="sticky top-0 z-50 bg-white border-b shadow-sm">
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 space-y-3 sm:space-y-0">
                        <button onClick={() => navigate('/')} className="flex items-center text-sm text-gray-600 hover:text-gray-900 self-start">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                                        ...
                                        <button
                                            ...
                                            className="px-6 py-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 disabled:bg-purple-300 flex items-center justify-center font-semibold w-full sm:w-auto"
                                        >
                                            {isGeneratingArticle ? (
                                                <>
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
                                            {resolvedImageUrl ? (
                                                <img
                                                    ...
                                                    alt="Current preview"
                                                    className="w-full sm:w-40 h-auto object-contain rounded-md border flex-shrink-0"
                                                />
                                            ) : (
                                                <div className="w-full sm:w-40 h-24 bg-gray-100 rounded-md flex items-center justify-center text-gray-400 text-sm">No Image</div>
                                            )}
