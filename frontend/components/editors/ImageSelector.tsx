    ...
    <div className="space-y-6">
      ...
      <div className="border-t pt-4">
        ...
        <div className="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0">
          ...
          <button onClick={handleStockPhotoSearch} disabled={isSearchingStockPhotos} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:bg-blue-300 flex items-center justify-center min-w-[100px] sm:flex-shrink-0">{isSearchingStockPhotos ? <Loader size={20} className="animate-spin" /> : t.search}</button>
        </div>
      ...
      <div className="border-t pt-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0">
            ...
            <button onClick={handleGenerateImage} disabled={isGenerating} className="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 disabled:bg-purple-300 flex items-center justify-center min-w-[100px] sm:flex-shrink-0">{isGenerating ? <Loader size={20} className="animate-spin" /> : t.generate}</button>
          </div>
        </div>
      </div>
    </div>
