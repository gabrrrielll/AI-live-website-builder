...
export const ServiceCardTopBorder: React.FC<{ sectionId: string, item: { id: number }, style?: React.CSSProperties }> = ({ sectionId, item, style }) => (
    <div style={style} className="p-8 rounded-lg border-t-4 border-[#c29a47] h-full">
