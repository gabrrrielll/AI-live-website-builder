...
export const StatCardLeftAligned: React.FC<{ sectionId: string, item: { id: number }, style?: React.CSSProperties }> = ({ sectionId, item, style }) => (
    <div className="p-6 rounded-lg flex items-center space-x-4 text-left" style={style}>
