            ...
            <div className="absolute inset-0 flex items-center justify-center p-8">
                {isEditMode ? (
                    <div className="text-center max-w-4xl">
                        {section?.elements?.[`${sectionId}-title-1`] ? (
                            ...
                            <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-6 bg-gradient-to-r from-white via-blue-200 to-purple-200 bg-clip-text text-transparent drop-shadow-lg">Construiește-ți Viitorul cu AI</h1>
                        )}
                        {section?.elements?.[`${sectionId}-subtitle-1`] ? (
                            ...
                            <div className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto drop-shadow-md">Utilizează puterea inteligenței artificiale generative pentru a crea site-uri web uimitoare, bogate în conținut, în doar câteva minute. <strong>Fără cunoștințe de programare.</strong></div>
                        )}
                        {section?.elements?.[`${sectionId}-cta-1`] ? (
                            ...
                            <button className="bg-white text-gray-900 font-bold py-4 px-8 rounded-full text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl">Începe Acum</button>
                        )}
                    </div>
                ) : (
                    <div className="text-center max-w-4xl">
                        <div
                            ...
                            dangerouslySetInnerHTML={{
                                __html: section?.elements?.[`${sectionId}-title-1`]?.content?.ro || 'Construiește-ți Viitorul cu AI'
                            }}
                        />
                        <div
                            className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto drop-shadow-md"
                            dangerouslySetInnerHTML={{
                                __html: section?.elements?.[`${sectionId}-subtitle-1`]?.content?.ro || 'Utilizează puterea inteligenței artificiale generative pentru a crea site-uri web uimitoare, bogate în conținut, în doar câteva minute. <strong>Fără cunoștințe de programare.</strong>'
                            }}
                        />
