# AI Live Website Builder - Frontend (React)

Frontend-ul aplicației este construit cu React.js și Vite, servind ca editor pentru website builder.

## 🚀 Tehnologii Folosite

- **React 18** - Framework principal pentru UI
- **Vite** - Build tool rapid și modern pentru development
- **React Router v6** - Routing pentru Single Page Application
- **react-helmet-async** - Management SEO și metadata
- **TypeScript** - Tipizare statică pentru code quality
- **Tailwind CSS** - Framework CSS utility-first
- **Radix UI** - Componente UI accesibile și moderne
- **PWA Support** - Progressive Web App features

## 🏗️ Arhitectura Frontend
